...
<html>
	...
	<body>
		...
		<div id="contenido">
			...
			<?php 
						include('/php/dameTodoUsuarios.php'); 
			?>
				
			</fieldset>
			
			<fieldset id="anunciantes" class="grupos">  <legend>Anunciantes Doobah!</legend>
			<?php 
						include('/php/dameTodoAnunciante.php'); 
			?>
			</fieldset> 
